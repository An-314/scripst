...
- [🚀 特性](#特性)
- [📦 インストール](#インストール)
  - [Typst のインストール](#typst-のインストール)
  - [Scripst テンプレートのダウンロード](#scripst-テンプレートのダウンロード)
    - [方法 1：手動ダウンロード](#方法-1手動ダウンロード)
    - [方法 2：Typst ローカルパッケージ管理の使用](#方法-2typst-ローカルパッケージ管理の使用)
- [📄 Scripst の使用](#scripst-の使用)
  - [Scripst テンプレートのインポート](#scripst-テンプレートのインポート)
  - [`article` ドキュメントの作成](#article-ドキュメントの作成)
- [🔧 テンプレートパラメータ](#テンプレートパラメータ)
- [✨ テンプレート効果の例と説明](#テンプレート効果の例と説明)
  - [`article` ドキュメント](#article-ドキュメント)
  - [`book` ドキュメント](#book-ドキュメント)
  - [`report` ドキュメント](#report-ドキュメント)
- [📜 貢献](#貢献)
- [📌 フォント](#フォント)
- [📦 依存](#依存)
- [🎯 TODO](#todo)
